...
export function AuthUniqueCodeForm(props: TAuthUniqueCodeForm) {
  const { mode, email, handleEmailClear, generateEmailUniqueCode, isExistingEmail: _isExistingEmail, nextPath } = props;
  // derived values
  ...
  const generateNewCode = async (emailAddr: string) => {
    try {
      setIsRequestingNewCode(true);
      const uniqueCode = await generateEmailUniqueCode(emailAddr);
